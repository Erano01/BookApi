...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext002_PersistenceInjection;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link BookUuidRepository}
 */
public class BookUuidRepository__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getBookUuidRepositoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext002_PersistenceInjection::apply);
