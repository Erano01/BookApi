...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext002_Autowiring4;
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext002_PersistenceInjection4;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link AuthorUuidRepository}
 */
public class AuthorUuidRepository__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getAuthorUuidRepositoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext002_PersistenceInjection4::apply);
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext002_Autowiring4::apply);
