...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext003_PersistenceInjection;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link BookRepository}
 */
public class BookRepository__TestContext003_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getBookRepositoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext003_PersistenceInjection::apply);
