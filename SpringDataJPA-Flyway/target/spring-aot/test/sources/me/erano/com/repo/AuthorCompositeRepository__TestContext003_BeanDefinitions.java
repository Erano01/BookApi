...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext003_PersistenceInjection1;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link AuthorCompositeRepository}
 */
public class AuthorCompositeRepository__TestContext003_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getAuthorCompositeRepositoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext003_PersistenceInjection1::apply);
