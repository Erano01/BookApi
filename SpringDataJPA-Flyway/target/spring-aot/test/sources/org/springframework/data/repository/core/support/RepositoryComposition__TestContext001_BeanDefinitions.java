...
public class RepositoryComposition__TestContext001_BeanDefinitions {
  ...
  public static class RepositoryFragments__BeanDefinitions {
    /**
     * Get the bean instance supplier for 'jpa.AuthorUuidRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.BookNaturalRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.BookUuidRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.AuthorCompositeRepository.fragments#0'.
     */
