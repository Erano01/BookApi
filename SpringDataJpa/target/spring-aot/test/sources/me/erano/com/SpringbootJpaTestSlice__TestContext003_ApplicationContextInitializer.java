 ...
 */
public class SpringbootJpaTestSlice__TestContext003_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SpringbootJpaTestSlice__TestContext003_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SpringbootJpaTestSlice__TestContext003_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
