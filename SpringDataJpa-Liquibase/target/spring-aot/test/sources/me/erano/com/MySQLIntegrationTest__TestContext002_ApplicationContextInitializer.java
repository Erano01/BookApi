 ...
 */
public class MySQLIntegrationTest__TestContext002_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new MySQLIntegrationTest__TestContext002_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new MySQLIntegrationTest__TestContext002_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
